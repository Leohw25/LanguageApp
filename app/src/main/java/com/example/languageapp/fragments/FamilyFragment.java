...
public class FamilyFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        words.add(new Word("father", "chichi", R.mipmap.family_father,R.raw.family_father));
        ...
        words.add(new Word("older brother", "aniki", R.mipmap.family_older_brother,R.raw.family_older_brother));
        words.add(new Word("younger brother", "otouto", R.mipmap.family_younger_brother,R.raw.family_younger_brother));
        words.add(new Word("older sister", "ane", R.mipmap.family_older_sister,R.raw.family_older_sister_ane));
        words.add(new Word("younger sister", "imouto", R.mipmap.family_younger_sister,R.raw.family_younger_sister));
